...
interface IncidentVolumeTrendCardProps {
  trend?: TrendAnalysis
  className?: string
}
...
export default function IncidentVolumeTrendCard({ trend, className = '' }: IncidentVolumeTrendCardProps) {
