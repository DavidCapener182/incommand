...
interface LogQualityTrendCardProps {
  trend?: TrendAnalysis
  className?: string
}

// Configuration
// Note: For "Quality", Increasing is GOOD (Green), Decreasing is BAD (Red)
const TREND_CONFIG = {
  increasing: {
    icon: TrendingUp,
...
export default function LogQualityTrendCard({ trend, className = '' }: LogQualityTrendCardProps) {
            ...
            <div className="h-2 w-full bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
              <div 
                ...
                style={{ 
                  ...
                  backgroundColor: safeType === 'increasing' ? '#10b981' : safeType === 'decreasing' ? '#ef4444' : '#3b82f6'
                }}
              />
            </div>
          </div>
