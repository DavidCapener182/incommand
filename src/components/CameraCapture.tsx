...
export const CameraCapture: React.FC<CameraCaptureProps> = ({
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md mx-4">
          <h3 className="text-lg font-semibold mb-4">Camera Not Supported</h3>
  ...
  if (cameraPermission === 'denied') {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md mx-4">
          <h3 className="text-lg font-semibold mb-4">Camera Permission Denied</h3>
          <p className="text-gray-600 mb-4">
          ...
          <div className="relative">
            ...
            {enableLocation && currentLocation && (
              <div className="absolute top-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-xs">
                <div className="flex items-center space-x-1">
                  <div className={`w-2 h-2 rounded-full ${isLocationAccurate(currentLocation) ? 'bg-green-400' : 'bg-yellow-400'}`}></div>
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-center space-x-4">
              ...
              <button
                ...
                className="p-4 bg-white rounded-full hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        {showPreview && capturedPhoto && (
          <div className="relative">
            ...
            {capturedPhoto.location && (
              <div className="absolute top-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-xs">
                <div className="flex items-center space-x-1">
                  <div className={`w-2 h-2 rounded-full ${isLocationAccurate(capturedPhoto.location) ? 'bg-green-400' : 'bg-yellow-400'}`}></div>
