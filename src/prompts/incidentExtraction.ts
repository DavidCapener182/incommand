...
- location: Extract ONLY the pure location name and ALWAYS capitalize the first letter of each word (e.g., "Male Toilets", "Main Stage", "North Gate"). Remove ALL callsigns, "by", "reported in", "in the", or any other text. Just the location name with proper capitalization.
- priority: One of urgent|high|medium|low based on severity. Rape, sexual assault, serious violence, medical emergencies, fires are "urgent". Missing children/persons, fights, theft, suspicious behavior are "high". Minor incidents are "medium" or "low". Artist events (on/off stage, performing, main act) are "low".
- confidence: 0-1 indicating certainty. Use 0.9+ for clear, unambiguous incidents (like "fight", "medical", "theft"). Use 0.7-0.8 for less clear cases.
