...
export async function POST(request: Request) {
  try {
    ...
    const DEFAULT_ACTION = 'Individual ejected from venue.';
    ...
    if (aiSource !== 'openai') {
      try {
        const model = process.env.OLLAMA_MODEL_EJECTION || process.env.OLLAMA_MODEL_DEFAULT;
    ...
    console.log('generate-ejection-details source=', aiSource);
