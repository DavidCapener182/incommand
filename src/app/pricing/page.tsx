      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            We're finalizing our pricing plans to best serve your event management needs.
          </p>
          <div className="bg-white dark:bg-[#1e2438] rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              Interested in learning more about our pricing? Contact us for early access and special pricing options.
            </p>
            <a
