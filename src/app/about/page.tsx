      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            Learn more about our mission to revolutionize event management and incident response.
          </p>
          <div className="bg-white dark:bg-[#1e2438] rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              InCommand is dedicated to providing professional event management and incident response platforms for festivals, venues, and public events. Our platform empowers teams to respond faster, communicate better, and keep events safe.
            </p>
            <p className="text-gray-700 dark:text-gray-300">
              More information about our story, team, and values coming soon.
            </p>
          </div>
